                                ...
                                <div class="card-body">
                                	<form method="post" id="form_1">
                                		...
                                		<div class="row mt-3">
                                            ...
                                            <!-- <div class="form-group col-md-6">
                                                <label>Station</label>
                                                <input type="text" name="deployment_station" id="deployment_station" class="form-control" required>
                                            </div> -->
                                			<div class="form-group col-md-3">
                                        ...
                                        <div class="border border-primary p-4 mb-3" id="spouseDetails" style="display: none;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="spouse_rank" id="spouse_rank" class="form-control">
                                                </div>
                                                <div class="form-group col-md-6">
                                    ...
                                    <form method="post" id="form_2" class="mt-3" style="display: none;">
                                        <legend>
                                            <div class="d-flex justify-content-between mb-5 border-bottom">
                                                ...
                                                <div><button id="addRow" type="button" class="btn btn-info btn-sm">Add Another Child / Dependent</button></div>
                                            </div>
                                        ...
                                        <legend>
                                            <table class="table table-borderless">
                                                <div class="d-flex justify-content-between mb-5 border-bottom">
                                                    ...
                                                    <div><button type="button" class="btn btn-outline-primary btn-sm" id="addVehicle">Add Another Vehicle</button></div>
                                                </div>
                                    ...
                                    <form method="post" id="form_4" class="mt-3" style="display: none;">
                                        <legend>
                                            <div class="d-flex justify-content-between border-bottom mb-5">
                                                ...
                                                <div><button type="button" id="addnewPvt" class="btn btn-outline-primary btn-sm">Add Another Employee</button></div>
                                            </div>
                                            <table class="table table-borderless">
                                                <tbody id="newPvt">
                                                    <div class="row">
