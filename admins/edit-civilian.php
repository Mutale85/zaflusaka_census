                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card mb-3 card p-3">
                                <div class="card-header">Add Civilian Resident</div>
                                <div class="card-body">
                                	<form method="post" id="form_1">
                                		...
                                		<div class="row mt-3">
                                			...
                                			<div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="service_number" id="service_number" class="form-control" required value="<?php echo $service_number ?>">
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" name="occupation" id="occupation" class="form-control" required value="<?php echo $occupation ?>">
                                            </div>
                                            <!-- <div class="form-group col-md-6">
                                                <label>Station</label>
                                                <input type="text" name="deployment_station" id="deployment_station" class="form-control" required value="<?php echo $deployment_station ?>">
                                            </div> -->
                                            <div class="form-group col-md-3">
                                        ...
                                        <div class="border border-primary p-4 mb-3" id="spouseDetails" style="display: none;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>Service Number (If Service Personnel)</label>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>Spouse Rank (If Service Personnel)</label>
                                                    <select name="spouse_rank" id="spouse_rank" class="form-control">
                                    ...
                                    <form method="post" id="form_2" class="mt-3" style="display: none;">
                                        <legend>
                                            <div class="d-flex justify-content-between mb-5 border-bottom">
                                                <div><h4 class="mb-3">Child / Dependent</h4></div>
                                                <div><button id="addRow" type="button" class="btn btn-info btn-sm"> <i class="bi bi-plus"></i> </button></div>
                                            </div>
                                            <table class="table table-borderless">
                                                ...
                                                ?>
                                                    ...
                                                    <div class="row border border-secondary mb-3 p-3">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="date" name="date_of_birth[]" id="date_of_birth" class="form-control" required value="<?php echo $date_of_birth ?>">
                                                        </div>
                                                        <?php
                                                            }
                                                        }
                                        ...
                                        <legend>
                                            <table class="table table-borderless">
                                                ...
                                                <?php
                                                    ...
                                                    echo '<tbody id="vehicle_table"></tbody>';
                                                }
                                                ?>
                                            </table>
                                            <div class="d-flex justify-content-between">
                                    ...
                                    <form method="post" id="form_4" class="mt-3" style="display: none;">
                                        <legend>
                                            <div class="d-flex justify-content-between border-bottom mb-5">
                                                ...
                                                <div><button type="button" id="addnewPvt" class="btn btn-outline-primary btn-sm"><i class="bi bi-plus"></i> </button></div>
                                            </div>
                                            <table class="table table-borderless">
                                                <?php
                                                ...
                                                <tbody id="newPvt">
                                                    <div class="row border border-primary mb-3 p-3">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label>Date of Birth</label>
                                                            <input type="date" name="date_of_birth[]" id="date_of_birth" class="form-control" required value="<?php echo $age ?>">
                                                        </div>
                                                        <div class="form-group col-md-6">
                                                            <label>NRC</label>
    ...
    <script>
    	...
    	$(function(){
			$("#form_1").submit(function(e){
				...
				var url = 'processing/submitCivilianData_1';
				$.ajax({
